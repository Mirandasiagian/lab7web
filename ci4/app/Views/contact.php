...
<div class="contact-container">
    <div class="contact-info">
        <p><strong><i class="fas fa-envelope"></i> Email:</strong> 
            <a href="mailto:mirandasiagian198@gmail.com">mirandasiagian198@gmail.com</a>
        </p>
        <p><strong><i class="fas fa-map-marker-alt"></i> Alamat:</strong>cikarang</p>
        <p><strong><i class="fas fa-phone"></i> Telepon:</strong> 
            <a href="tel:+6281286275726">+62 813-6608-3182</a>
        </p>
    </div>
